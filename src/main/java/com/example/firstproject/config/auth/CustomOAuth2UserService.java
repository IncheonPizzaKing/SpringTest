...
import com.example.firstproject.config.auth.dto.OAuthAttributes;
import com.example.firstproject.config.auth.dto.SessionUser;
import com.example.firstproject.domain.user.User;
import com.example.firstproject.domain.user.UserRepository;
